...
export default function GoalPostView(props: {
	...
	return <div>
		{props.postData.isAutoTranslated
			...
			>
				<div><Info/></div>
				<div>This text was automatically translated to {props.postData.languageName} language by LLM tool.</div>
				</div>
			: undefined
		}
		{props.postData.languageNamePending
			...
			>
				...
				<div>The automatic translation of this text to {props.postData.languageNamePending} language is not available yet.
