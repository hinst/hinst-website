export class Requests {
	...
	async css1() {
		const response = await fetch(
			"http://192.168.0.23:30001/hinst-website/app.3e369f90.css",
			{
				headers: {
	...
	async css2() {
		const response = await fetch(
			"http://192.168.0.23:30001/hinst-website/app.bef21471.css",
			{
				headers: {
					accept: "text/css,*/*;q=0.1",
					"accept-language":
	...
	async javaScript() {
		const response = await fetch(
			"http://192.168.0.23:30001/hinst-website/app.9da11e27.js",
			{
				headers: {
					accept: "*/*",
					"accept-language":
	...
	async icon() {
		const response = await fetch(
			"http://192.168.0.23:30001/hinst-website/icon.fd8aa8a2.webp",
			{
				headers: {
	...
	async api2() {
		const response = await fetch(
			"http://192.168.0.23:30001/hinst-website/api/goal?id=247488",
			{
				headers: {
					accept: "*/*",
					"accept-language": "ru",
